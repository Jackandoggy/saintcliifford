...
def aries_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can see updates of {dispatcher.bot.first_name} by joining [this channel](https://t.me/check_this_channel).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
...
def main():
    ...
    help_handler = CommandHandler("hastold", get_help, run_async=True)
    ...
    donate_handler = CommandHandler("gfrdshu", donate, run_async=True)
